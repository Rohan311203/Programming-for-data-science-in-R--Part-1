#creating vectorsfor each column 

Reg.No <- c("24BCE1001","24BCE1002","24BCE1003","24BCE1004","24BCE1005","24BCE1006","24BCE1007","24BCE1008","24BCE1009","24BCE1010")
...
# creating a duplicate of the marks 3 column 
Subject3_Marks <- Subject3   

#Create the data frame
students <- data.frame(Reg.No = Reg.No, Name = Name, Programme = Programme, Specialization = Specialization, Subject1 = Subject1, Subject2 = Subject2, Subject3 = Subject3, Subject4 = Subject4,
Subject3_Marks = Subject3_Marks,stringsAsFactors = FALSE
)
...
#Rank by Sum (highest Sum = rank 1)
students$Rank <- rank(-students$Sum, ties.method = "min")

#Print full table, then sorted by Rank
print(students)
